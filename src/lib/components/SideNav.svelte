...
<div class="flex flex-col justify-start fixed h-full transition-all duration-700 border-r-2 border-gray-200 {closed ? 'w-16':'w-56'}" >
    ...
    <button onclick={()=>goto("/focus")} class="hover:bg-neutral-200 h-16 transition-all duration-700 flex items-center justify-evenly {closed ? 'w-16 pr-2': 'w-56'}">
        <div class="transition-all text-start text-lg {!closed ? 'w-36 opacity-100 duration-700 pl-4':'w-0 opacity-0 duration-500'} ">Focus</div>
